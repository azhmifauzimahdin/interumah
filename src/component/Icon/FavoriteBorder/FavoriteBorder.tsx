...
const FavoriteBorder: React.FC<FavoriteBorderProps> = props => {
    ...
    return (
        <svg onClick={onClick} className={active ? `favoriteBorder favoriteBorder-color-${color} favoriteBorder-size-${size} favoriteBorder-active-${color}` : `favoriteBorder favoriteBorder-color-${color} favoriteBorder-size-${size}`} viewBox="0 0 27 25" xmlns="http://www.w3.org/2000/svg">

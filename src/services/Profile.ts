...
import { RequestChangePassword, RequestUpdataProfile, RequestUpdateEmail, RequestUpdateImageProfile, ResponseProfile, ResponseUpdateProfile } from "../types/User";
...
export const updateImageProfil = async (request: RequestUpdateImageProfile): Promise<AxiosResponse<ResponseUpdateProfile>> => {
